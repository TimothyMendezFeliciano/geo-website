                              ...
                              <div className="wpo-team-img">
                                  ...
                                  <div className={`social ${isActive === attorney.Id ? "active" : ""}`}>
                                      <ul>
                                          ...
                                          <li className="on"><Link href="/"><i className="ti-facebook"></i></Link></li>
                                          <li className="on"><Link href="/"><i className="ti-twitter-alt"></i></Link></li>
                                          <li className="on"><Link href="/"><i className="ti-instagram"></i></Link></li>
                                      </ul>
                                  </div>
                              </div>
                              <div className="wpo-team-text">
                                  <h2><Link onClick={ClickHandler} href="/attorneys-single/[slug]" as={`/attorneys-single/${attorney.slug}`}>{attorney.name}</Link></h2>
