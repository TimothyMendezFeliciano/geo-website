...
const AttorneysSinglePage = (props) => {
    ...
    const AttorneysSingle = Attorneys.find(item => item.slug === router.query.slug)
    ...
    return (
        <Fragment>
            <Navbar Logo={Logo}/>
            <PageTitle pageTitle={AttorneysSingle?.name} pagesub={AttorneysSingle?.title} />
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-6">
                                <div className="attorney-info-img">
                                    <Image src={AttorneysSingle?.AtImg} alt="" />
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="attorney-info-text">
                                    <h2>{AttorneysSingle?.name}</h2>
                                    <ul>
                                        <li>Position: <span>Siniour Lawyer</span></li>
                                        <li>Practice Area:<span>{AttorneysSingle?.title}</span></li>
